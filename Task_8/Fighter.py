from Task_8.Salary import Salary
from Task_8.Person import Person
from Task_8.Mixins import FoodMixin, WeightMixin
from Task_8.decorators import *
from Task_8.Exceptions import *
...
class Fighter(Person, FoodMixin, WeightMixin):
    ...
    def __init__(self, name="Иван", surname="Иванов", age=20, weight=70, discharge='3', patronymic='', salary=0):
    ...
    def who_am_i(self):
        ...
        return "Hello, I am a Fighter {0}!".format(self)
